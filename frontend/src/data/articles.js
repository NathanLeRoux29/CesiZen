...
export const articles = [
  {
    ...
    category: 'Méditation',
    description: 'Découvrez comment quelques minutes de méditation par jour peuvent transformer votre quotidien.',
    content: `La méditation est une pratique ancienne qui offre de nombreux bénéfices pour la santé mentale et physique. En vous accordant seulement 10 minutes chaque jour, vous pouvez réduire considérablement votre niveau de stress et améliorer votre concentration.
...
À long terme, la méditation modifie la structure même du cerveau, renforçant les zones liées à l'empathie et à la régulation émotionnelle. C'est un véritable entraînement pour l'esprit, permettant de naviguer avec plus de sérénité dans les défis du quotidien.`,
  ...
  {
    id: 2,
    title: 'Guide Complet du Yoga du Matin',
    image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=800',
    category: 'Yoga',
    description: 'Une routine de yoga matinale pour démarrer votre journée du bon pied.',
    content: `Le yoga matinal est excellent pour éveiller votre corps et votre esprit après une nuit de repos. Commencer sa journée par quelques étirements conscients permet de libérer les tensions accumulées et de préparer le système nerveux à l'activité.
...
Même si vous n'avez que 15 minutes, l'important est la régularité. Le yoga n'est pas seulement une question de souplesse physique, c'est une invitation à l'écoute de soi et à la présence, créant un espace de calme avant le tumulte de la journée.`,
  ...
  },
  {
    ...
    description: 'Apprenez les meilleures techniques de respiration pour calmer votre esprit.',
    content: `La respiration est un outil puissant pour gérer le stress et l'anxiété car elle agit directement sur le système nerveux autonome. Contrairement aux battements du cœur, la respiration est une fonction automatique que nous pouvons contrôler volontairement.
...
Une autre méthode efficace est la respiration abdominale. En gonflant le ventre à l'inspiration, on stimule le nerf vague, ce qui envoie un signal de relaxation immédiat au cerveau. C'est une technique discrète que vous pouvez pratiquer n'importe où, que ce soit dans les transports ou avant une réunion importante.`,
  ...
  {
    id: 5,
    title: 'Alimentation Saine pour l\'Équilibre Mental',
  ...
  {
    id: 6,
    title: 'La Nature: Votre Alliée Bien-être',
  ...
  {
    id: 7,
    title: 'Gestion des Émotions au Quotidien',
  ...
  {
    id: 8,
    title: 'Les Bienfaits du Sport sur le Mental',
  ...
  {
    id: 9,
    title: 'Créer un Espace de Détente chez Soi',
  ...
  {
    id: 10,
    title: 'L\'Importance des Relations Sociales',
  ...
  {
    id: 11,
    title: 'Digital Detox: Déconnectez-vous pour mieux vous reconnecter',
  ...
  {
    id: 12,
    title: 'Gratitude: La Clé du Bonheur',
