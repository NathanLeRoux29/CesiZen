          ...
          <v-card class="login-card pa-8 pa-md-12" elevation="0" rounded="xl">
            ...
            <v-form ref="form" v-model="isFormValid" @submit.prevent="handleSubmit">
              ...
              <div v-if="!isRegisterMode" class="d-flex justify-end mb-8">
                <a class="text-primary text-body-2 forgot-link" href="#" @click.prevent="errorMessage = 'Bientôt disponible'">
                  Mot de passe oublié ?
                </a>
              </div>
              ...
              <div class="text-center mt-4">
                <p class="text-body-2 text-info opacity-70">
                  ...
                  <a class="text-primary font-weight-bold ml-1 active-link" href="#" @click.prevent="toggleMode">
